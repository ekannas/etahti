...
public class BuktiMesinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bukti_mesin);
        this.getSupportActionBar().setTitle("Bukti Peralatan/Mesin");
        Intent i = getIntent();
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                simpanMesin(roda2, roda3,roda4, rodalbh4,truck, dumptruck, tangki, trailer, sepeda,
    ...
    private void simpanMesin(final String roda2,final String  roda3,final String roda4,final String  rodalbh4,final String truck,
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (Msg.equals("true")) {
                        ...
                        Intent i = new Intent(BuktiMesinActivity.this, BarangBuktiTambahActivity.class);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BuktiMesinActivity.this);
