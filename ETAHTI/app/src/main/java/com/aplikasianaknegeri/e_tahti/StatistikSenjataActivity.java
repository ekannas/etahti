...
public class StatistikSenjataActivity extends AppCompatActivity {


    private TextView edLarasPendek, edAmunisi, edGranatEmas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistik_senjata);
        this.getSupportActionBar().setTitle("Statistik Senjata");
        ...
        db = new SQLiteHandler(StatistikSenjataActivity.this);
        session = new SessionManager(StatistikSenjataActivity.this);
    ...
    private void loadBarangBukti(final String id_satker){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, APIConfig.urlAPI + "/api/statistik_bb_senjata", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject obj = new JSONObject(response);
                    ...
                    if (Msg.equals("true")) {
                        JSONObject user = obj.getJSONObject("user");
                        edLarasPendek.setText(user.getString("laras_pendek"));
                        edAmunisi.setText(user.getString("amunisi"));
                        edGranatEmas.setText(user.getString("granat"));
                    } else if (Msg.equals("false")) {
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
    ...
    private void logoutUser() {
        ...
        db.deleteUser();
        Intent intent = new Intent(StatistikSenjataActivity.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
    @Override
    public void onBackPressed() {
        Intent i = new Intent(StatistikSenjataActivity.this, StatistikBuktiActivity.class);
        startActivity(i);
        finish();
        super.onBackPressed();
    }
