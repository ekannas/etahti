        ...
        btnSimpanSenjata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String granat = edGranatEmas.getText().toString();
                    ...
                    simpanSenjata(IDBUKTIDETAIL,laraspendek, amunisi, granat);

            }
        });
    }
    private void simpanSenjata(final String iddetail,final String laraspendek, final String amunisi, final String granat)
    {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (Msg.equals("true")) {
                        ...
                        Intent i = new Intent(DetailSenjataActivity.this, DetailBuktiActivity.class);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DetailSenjataActivity.this);
        requestQueue.add(stringRequest);
    }
    private void loadBarangBukti(final String idtahanan){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, APIConfig.urlAPI + "/api/detail_bb_senjata", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject obj = new JSONObject(response);
