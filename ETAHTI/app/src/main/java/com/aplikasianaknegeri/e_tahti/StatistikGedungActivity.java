...
public class StatistikGedungActivity extends AppCompatActivity {
    TextView edGedung;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistik_gedung);
        this.getSupportActionBar().setTitle("Statistik Gedung");
        edGedung = findViewById(R.id.edGedung);
        db = new SQLiteHandler(StatistikGedungActivity.this);
        session = new SessionManager(StatistikGedungActivity.this);
    ...
    private void loadBarangBukti(final String id_satker){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, APIConfig.urlAPI + "/api/statistik_bb_gedung", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject obj = new JSONObject(response);
    ...
    private void logoutUser() {
        ...
        db.deleteUser();
        Intent intent = new Intent(StatistikGedungActivity.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
    @Override
    public void onBackPressed() {
        Intent i = new Intent(StatistikGedungActivity.this, StatistikBuktiActivity.class);
        startActivity(i);
        finish();
        super.onBackPressed();
    }
