...
public class BuktiPersediaanActivity extends AppCompatActivity {
    Button btnSimpan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bukti_persediaan);
        this.getSupportActionBar().setTitle("Bukti Barang Persediaan");
        Intent i = getIntent();
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                simpanPersediaan(meranti, ulinMeter,ulinPotong,campuran,borneo,batangPotong,papanMeter, rotan, olahan, lainlainHutan,
    ...
    private void simpanPersediaan(final String meranti, final String ulinMeter,final String ulinPotong,final String campuran,final String borneo,final String batangPotong,final String papanMeter,final String  rotan,final String  olahan,final String  lainlainHutan,
                                  ...
                                  final String dompet,final String  tas,final String  celana,final String  sendal,final String  jaket,final String  ikan,final String  kerbau,final String  lainnya)
    {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (Msg.equals("true")) {
                        ...
                        Intent i = new Intent(BuktiPersediaanActivity.this, BarangBuktiTambahActivity.class);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BuktiPersediaanActivity.this);
