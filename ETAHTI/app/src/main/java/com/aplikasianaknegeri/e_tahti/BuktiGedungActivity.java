...
public class BuktiGedungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bukti_gedung);
        this.getSupportActionBar().setTitle("Bukti Gedung Bangunan");
        Intent i = getIntent();
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                simpanGedung(gedung);
//                Intent i = new Intent(BuktiGedungActivity.this, BarangBuktiActivity.class);
//                startActivity(i);
//                finish();
            }
        });
    }
    private void simpanGedung(final String gedung){
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (Msg.equals("true")) {
                        ...
                        Intent i = new Intent(BuktiGedungActivity.this, BarangBuktiTambahActivity.class);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BuktiGedungActivity.this);
