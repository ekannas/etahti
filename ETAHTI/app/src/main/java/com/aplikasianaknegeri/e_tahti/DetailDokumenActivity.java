...
public class DetailDokumenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("Detail Bukti Dokumen/Surat Berharga");
        Intent i = getIntent();
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String ktp = edKTP.getText().toString();
                    ...
                    simpanDokumen(IDBUKTIDETAIL,cek,bukutab,atm,sertifikat,rekkoran,suratper,kwitansi,faktur,bpkb,stnk,sim,ktp);

            }
        });

    }
    private void simpanDokumen(final String iddetail,final String cek,final String bukutab,final String atm,final String sertifikat,final String rekkoran,final String suratper,final String kwitansi,final String faktur,final String bpkb,final String stnk,final String sim,final String ktp){
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (Msg.equals("true")) {
                        ...
                        Intent i = new Intent(DetailDokumenActivity.this, DetailBuktiActivity.class);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DetailDokumenActivity.this);
        requestQueue.add(stringRequest);
    }

    private void loadBarangBukti(final String idtahanan){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, APIConfig.urlAPI + "/api/detail_bb_dokumen", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject obj = new JSONObject(response);
